...
while True:
	...
	for i in range(1, len(letters) + 1):
		lettersComb = [''.join(comb) for comb in
		               list(itertools.permutations(letters, i))]  # Here we use '=' to reset it each time so as not to waste time repeating combinations from previous iterations
